...
(function() {
	...
	Oskari.clazz
			.define(
					"Oskari.mapframework.openlayers.mapfull.Bundle",
					/**
					 * @constructor
					 * 
	...
	var metas = Oskari.clazz
			.getMetadata('Oskari.mapframework.openlayers.mapfull.Bundle');
	 ...
	 * 
	 */
	Oskari.bundle_manager.installBundleClass("openlayers-map-full",
			"Oskari.mapframework.openlayers.mapfull.Bundle");
